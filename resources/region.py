...
class Region:
    ...
    def create_regions(rap):
        ...
        possible_task_values = Region.find_possible_task_values(fixed_ids, fixed_values, fluent_ids,
    ...
    @staticmethod
    def find_possible_task_values(fixed_ids, fixed_values, fluent_ids, resource_requirements, budget):
        ...
        while within_budget:
            ...
            if (final_costs > budget).any():
                ...
                values = Region.find_possible_task_values(new_fixed_ids, new_fixed_values, new_fluent_ids,
                                                          resource_requirements, budget)
                valid_values += values
            value += 1
