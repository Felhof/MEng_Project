...
adp_problem = {
    ...
    "regions": {
        1: Region([TaskCondition(task_id=2, min_value=0, max_value=0)]),
        2: Region([TaskCondition(task_id=2, min_value=1, max_value=1)]),
        3: Region([TaskCondition(task_id=2, min_value=2, max_value=2)])
    },
